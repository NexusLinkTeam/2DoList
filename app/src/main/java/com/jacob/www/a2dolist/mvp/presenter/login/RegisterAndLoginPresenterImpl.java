...
import com.jacob.www.a2dolist.mvp.presenter.Impl.BasePresenterImpl;
import com.jacob.www.a2dolist.mvp.view.RegisterAndLoginView;
import com.jacob.www.a2dolist.ui.activity.MainActivity;
import com.jacob.www.a2dolist.ui.login.FinishRegisterActivity;
...
public class RegisterAndLoginPresenterImpl extends BasePresenterImpl<RegisterAndLoginView> implements RegisterAndLoginPresenter {
    ...
    @Override
    public void logIn(final LogInActivity context, final String uId, String password) {
                    ...
                    if(i ==0){
                        ...
                        if(file==null){
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    context.btnLogin.performClick();
                                }
                            },1000);
                        }
                        SharePreferenceManager.setCachedAvatarPath(file.getAbsolutePath());
                        SharePreferenceManager.setCachedNickname(name);
